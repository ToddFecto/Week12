...
namespace BookAPIDemo.Controllers
{
    public class HomeController : Controller
    {
        ...
        // ALthough this function LOOKS like it returns something called Task<IActionResults>, in fact it actually just returns an IActionResult.
        // So for example, if we have an asyn function that returns a string, we have to make the return type Task<string>. Our function
        // STILL returns a string though, and will have a line such as return "Hello".
        public async Task<IActionResult> testapicall(string author)
        {
